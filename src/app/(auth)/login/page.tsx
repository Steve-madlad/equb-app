...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-slate-50 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-emerald-950 px-4 py-12 transition-colors duration-300">
      ...
      {/* Background glow circles (dark mode only) */}
      ...
      <div className="relative w-full max-w-md">
        ...
        {/* Card Container */}
        <div className="rounded-3xl border border-slate-200/80 dark:border-white/10 bg-white dark:bg-white/[0.04] backdrop-blur-xl shadow-xl shadow-slate-200/60 dark:shadow-black/25 dark:shadow-black/25 dark:shadow-2xl p-8 sm:p-10 text-slate-900 dark:text-slate-100 transition-all">
